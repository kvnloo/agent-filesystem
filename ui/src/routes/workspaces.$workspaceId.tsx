    ...
    return (
      <PageStack>
        <EmptyState role="alert">
          ...
          <NoticeBody>This workspace may have been deleted or is unavailable in the selected database.</NoticeBody>
          <Button size="medium" variant="secondary-fill" onClick={() => { void navigate({ to: "/workspaces" }); }}>Back to Workspaces</Button>
        </EmptyState>
      </PageStack>
    );
  }
  ...
  return (
    <PageStack>
      ...
      <StudioNavRow>
        ...
        <StudioActions>
          <Button size="medium" variant="secondary-fill" onClick={() => setForkDialogOpen(true)}>Fork workspace</Button>
          {hasAgents ? (
            <ViewAgentsButton
              variant="secondary"
              size="large"
            ...
            <ConnectAgentButton
              variant="secondary"
              size="large"
              onClick={() => { setUserRequestedBanner(true); setBannerDismissed(false); }}
            >
              Connect agent
            </ConnectAgentButton>
          )}
      ...
      <ForkWorkspaceDialog workspace={workspace} open={forkDialogOpen} onClose={() => setForkDialogOpen(false)} />
      {deleteDialogOpen ? (
        <DialogOverlay
          role="dialog"
          aria-modal="true"
...
function workspaceCommandsFor(
  ...
  const sections: WorkspaceCommandSection[] = [
    ...
    },
    {
      ...
      description: "Print workspace history as structured output.",
